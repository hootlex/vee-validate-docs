<template>
    <code-example>
        <div slot="example">
            <form @submit.prevent="validateForm('form-1')" class="pure-form pure-form-stacked">
                <legend>Form 1</legend>
                <div class="pure-u-1">
                    <label :class="{'error': errors.has('name', 'form-1') }" for="name">Name</label>
                    <input v-validate data-rules="required|alpha" data-scope="form-1" :class="{'pure-input-1': true, 'has-error': errors.has('name', 'form-1') }" name="name" type="text">
                ...
                <div class="pure-u-1">
                    ...
                    <input v-validate data-rules="required|email" data-scope="form-1" :class="{'pure-input-1': true, 'has-error': errors.has('email', 'form-1') }" name="email" type="text">
                ...
                <button class="pure-button pure-button-danger" type="button" name="button" @click="errors.clear('form-1')">Clear</button>
            </form>

            <form @submit.prevent="validateForm('form-2')" class="pure-form pure-form-stacked" data-scope="form-2">
                ...
                <div class="pure-u-1">
                    <label :class="{'error': errors.has('password', 'form-2') }" for="email">Password</label>
                    <input v-validate data-rules="required|min:6" :class="{'pure-input-1': true, 'has-error': errors.has('password', 'form-2') }" name="password" type="password">
                    <span class="error" v-show="errors.has('password', 'form-2')">{{ errors.first('password', 'form-2') }}</span>
                </div>

                <button class="pure-button pure-button-primary" type="submit" name="button">Log in</button>
                <button class="pure-button pure-button-danger" type="button" name="button" @click="errors.clear('form-2')">Clear</button>
            </form>
        </div>
